...
@section('content')
    ...
    <section class="row main-content justify-content-center">
        <div class="col-lg-8 ">
            <div class="card">
                <h3 class="page-title card-header">Edit Hospital</h3>
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('hospital.update', $hospital->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" id="address" name="address" value="{{old('name', $hospital->address)}}" required>
                            </div>
                        </div>
